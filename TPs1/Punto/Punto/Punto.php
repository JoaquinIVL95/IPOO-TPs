...
class Punto{
	...
	// public function setCoordenada_x($nuevoValorcoord_x){
	// 	$this->coordenada_x = $nuevoValorcoord_x;
	// }
	
	// public function setCoordenada_y($nuevoValorcoord_y){
	// 	$this->coordenada_y = $nuevoValorcoord_y;
	// }
